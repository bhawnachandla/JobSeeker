  ...
  <section class="banner-bottom-wthree pt-lg-5 pt-md-3 pt-3">
    ...
    <!---728x90--->
      <h3 class="tittle text-center mb-lg-5 mb-3">
        <span>Admin Panel</span>View jobs</h3>
        <!---728x90--->
                    ...
                    if(mysqli_num_rows($res)>0)
                    {
                      while($row = mysqli_fetch_array($res)){
                        ...
                        <tr>
                          ...
                          <td><?php echo $row['jdescription'];?></td> <td><?php echo $row['status'];?></td>
                          
                          <td><a href="deletejob.php?x=<?php echo$row['jid'];?>"class="btn btn-dark">Delete</a></td>
                        </tr>
                        <?php
                      }
                    }
