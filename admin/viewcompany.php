  ...
  <section class="banner-bottom-wthree pt-lg-5 pt-md-3 pt-3">
    ...
    <!---728x90--->
      <h3 class="tittle text-center mb-lg-5 mb-3">
        <span>Admin Panel</span>View Company</h3>
        <!---728x90--->
                  ...
                  <?php
                    ...
                    if(mysqli_num_rows($res)>0)
                    {
                      while($row = mysqli_fetch_array($res)){
                        ?>
                        <tr>
                          <th scope="row"><?php echo $row['coname'];?></th>
                          <td><?php echo $row['coexperience'];?></td>
                          <td><?php echo $row['cophone'];?></td> 
                          
                          <td><a href="deletecompany.php?x=<?php echo$row['coid'];?>"class="btn btn-dark">Delete</a></td>
                        </tr>
                        <?php
                      }
                    }
