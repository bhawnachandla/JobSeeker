    ...
    <footer class="footer-emp-w3layouts bg-dark dotts py-lg-5 py-3">
        <div class="container-fluid px-lg-5 px-3">
            <div class="row footer-top">
                <div class="col-lg-3 footer-grid-wthree-w3ls">
                    ...
                    <div class="footer-text">
                        <p>Learn more about jobs and carrer opportunorities.Job Seekers is your source for jobs and carrer opportuities.A leading job portal in Jalandhar.</p>
                    </div>
                </div>
                <div class="col-lg-3 footer-grid-wthree-w3ls">
                    <div class="footer-title">
                    ...
                    <div class="contact-info">
                        ...
                        <div class="phone">
                            <h4>Contact :</h4>
                            <p>Phone :+918725934109 </p>
                            <p>+918725932769</p>
                            <p>Email :jobseekers@gmail.com
                                <a href="mailto:jobseekers@gmail.com"></a>
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="copyright mt-4">
                <p class="copy-right text-center ">&copy; 2021 Job Seekers. All Rights Reserved |
                    ...
                    <div class="login px-4 mx-auto mw-100">
                        ...
                        <form action="" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="file" class="form-control" placeholder="" required="" name="upic">
                            </div>
